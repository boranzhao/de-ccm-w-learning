function [output, state] = uncer_func_poor(input, params, varargin)
%UNCER_FUNC_POOR Function implementing an imported ONNX network.
%
...
%
% [OUTPUT] = uncer_func_poor(INPUT, PARAMS)
%			- Evaluates the imported ONNX network UNCER_FUNC_POOR with input(s)
%			INPUT and the imported network parameters in PARAMS. Returns
%			network output(s) in OUTPUT.
%
% [OUTPUT, STATE] = uncer_func_poor(INPUT, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = uncer_func_poor(INPUT, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Function to validate inputs to uncer_func_poor:
p = inputParser;
