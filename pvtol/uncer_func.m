...
[Vars.x28, NumDims.x28] = PLACEHOLDER(Vars.x27);
...
% PLACEHOLDER FUNCTION FOR UNSUPPORTED OPERATOR (Softplus):
[Vars.x36, NumDims.x36] = PLACEHOLDER(Vars.x35);
...
% PLACEHOLDER FUNCTION FOR UNSUPPORTED OPERATOR (Softplus):
[Vars.x44, NumDims.x44] = PLACEHOLDER(Vars.x43);
...
% PLACEHOLDER FUNCTION FOR UNSUPPORTED OPERATOR (Softplus):
[Vars.x52, NumDims.x52] = PLACEHOLDER(Vars.x51);
